...
import { checkEnvExists, checkEnviromentFolderExists } from './helpers/check-env-exists.js';
...
log(chalkTemplate`{black {bgGreen  ${center(welcome)} }}
`)

usesDefaultWarn(isEnvSet);
await checkEnviromentFolderExists();
checkEnvExists();
